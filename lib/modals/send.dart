...
class SendModal extends StatelessWidget {
          ...
          child: FutureBuilder<dynamic>(
            ...
            builder: (context, snapshot) {
              return Column(children: [
                ...
                const Padding(
                    child: Text('SMS-Versand', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
  ...
  Future<String> sendSms() async {
    if(await _storage.containsKey(key: "username") && await _storage.containsKey(key: "password")) {
      ...
      return Future.error("Legen Sie zuerst in den Einstellungen (rechts oben) Benutzername und Passwort fest.");
    }
  }
}