    ...
    return AlertDialog(
      content: SingleChildScrollView(
          child: Column(children: [
            ...
            const Padding(
                child: Text('Über diese App', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
                padding: EdgeInsets.fromLTRB(0, 10, 0, 0)
            ),
            const Padding(
                child: Text('Diese Open-Source-App wurde von insComers entwickelt und ist keine offizielle App von firmensms.at.'),
